...
- [ ] **人工走查（来自 coverage 分析结论）：** 官网确认 fare family 结构 + Top 3 CPs 比价验证。P0: AA/BR/CI（supply gap），P1: NH/JL/VF（selection gap），P2: EK/AC/UA/DL
- [ ] 低 share 航司排查：用现有方法论补完余下航司
- [ ] 跟进 automated brand fare mapping 进度，准备交接 coverage tracking
